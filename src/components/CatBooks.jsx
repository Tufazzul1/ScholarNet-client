...
const CatBooks = ({catBooks}) => {
    const [isHovered, setIsHovered] = useState(false);
    const {_id, image, name, author , category , rating} = catBooks;
            ...
            >
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-end">
                        <Link to={`/details/${_id}`}  className="btn border-green-500 w-full btn-sm hover:bg-green-500">Details</Link>
                    </div>
                </div>
            </div>
        </div>
